...
<section class="uk-section">
    <div class="uk-container">
        <table class="uk-table uk-table-hover uk-table-divider uk-table-striped">
            ...
            <tbody>
            <%--@elvariable id="" type="java.util.List"--%>
...
<section class="uk-section">
    <div class="uk-container">
        <form action="<c:url value="/Rental_company"/>" class="uk-form-horizontal" method="POST">

            <div class="uk-margin">
                <label class="uk-form-label" for="RentalCompany_name">Company Name:</label>
